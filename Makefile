...
srcdir = .
topdir = /Users/sumanth/.rvm/rubies/ruby-2.3.0/include/ruby-2.3.0
hdrdir = $(topdir)
arch_hdrdir = /Users/sumanth/.rvm/rubies/ruby-2.3.0/include/ruby-2.3.0/x86_64-darwin14
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby

prefix = $(DESTDIR)/Users/sumanth/.rvm/rubies/ruby-2.3.0
...
LIBRUBYARG_STATIC = -lruby.2.3.0-static -framework CoreFoundation
empty =
OUTFLAG = -o $(empty)
COUTFLAG = -o $(empty)
...
DEFS     = 
CPPFLAGS =   -I/usr/local/opt/libyaml/include -I/usr/local/opt/readline/include -I/usr/local/opt/libksba/include -I/usr/local/opt/openssl/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags) -arch x86_64 -I/Users/sumanth/.rvm/gems/ruby-2.3.0/gems/rice-2.1.0/ruby/lib/include
CXXFLAGS = $(CFLAGS)  -Wall -g
ldflags  = -L. -fstack-protector -L/usr/local/lib -L/usr/local/opt/libyaml/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libksba/lib -L/usr/local/opt/openssl/lib  -L/Users/sumanth/.rvm/gems/ruby-2.3.0/gems/rice-2.1.0/ruby/lib/lib -lrice -lcryptopp
...
target_prefix = 
LOCAL_LIBS = 
LIBS = -lruby.2.3.0 -lpthread -ldl -lobjc 
ORIG_SRCS = encrypt.cpp
SRCS = $(ORIG_SRCS) 
OBJS = encrypt.o
HDRS = 
TARGET = encrypt
